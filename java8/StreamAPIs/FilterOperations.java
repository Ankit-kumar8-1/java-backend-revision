...
public class FilterOperations {
        public static void main(String[] args) {
                ...
                list.stream().filter(x -> x % 2 == 0 || x % 3 == 0) // number ko 2 or 3 se jo divisable hai un ko le
                                                                    // rahe
                ...
                long count = names.stream().filter(n -> n.length() > 5).count(); // jis string ke length 6 se greater
                                                                                 // hai un ko
                                                                                 // count kar rahe hai
                System.out.println("Total String greater than 5 : " + count);

                // Multiple filter() Chaining
                List<Integer> numbIntegers = List.of(1, 34, 2, 43, 55, 67, 4, 3, 22, 67, 433, 23, 990, 56, 78, 54, 33,
                                4, 5, 6,
                                7,
                                8);
